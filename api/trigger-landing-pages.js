/**
 * Vercel Serverless Function - Proxy to n8n landing page workflow
 * Triggers landing page generation (Product Page + Advertorial)
 */

const N8N_WEBHOOK_URL = 'https://n8n.srv1300789.hstgr.cloud/webhook/launchpad-landing-gen';
...
export default async function handler(req, res) {
  ...
  try {
    // Forward the request to n8n (same payload structure as banners)
    const response = await fetch(N8N_WEBHOOK_URL, {
      ...
      body: JSON.stringify({
        ...
        // Status
        status: req.body.status || 'landing_page',
